...
- `update-scripts`: will pull the github actions, templates, and style configs from the [undefined](https://github.com/asdasdasd/undefined) repository, overwriting the existing.
